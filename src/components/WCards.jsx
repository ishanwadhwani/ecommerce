...
import d1 from '../assests/dress1.jpg'
import d2 from '../assests/dress2.jpg'
import d3 from '../assests/dress3.jpg'
import d4 from '../assests/dress4.jpg'
import d5 from '../assests/dress5.jpg'
import d6 from '../assests/dress6.jpg'
...
const WCards = () => {
  return (
    ...
    <div className='flex flex-row justify-between'>
        <h2 className='text-3xl px-6'>Women's Collection</h2>
    ...
    <Swiper
      ...
      >
        ...
        <SwiperSlide>
        <div className='card bg-gray-100'>
            <img src={ d5 } className='w-full h-full object-cover transition ease-in-out delay-150 hover:translate-x-0.7 hover:scale-110 duration-300' alt="dress" />
            <div className='p-5 flex flex-col gap-3'>
                <div className='flex items-center gap-2'>
                    <span className='title'>In Stock</span>
                    <span className='title'>Official Store</span>
